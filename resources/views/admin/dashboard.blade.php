            ...
            <table class="table table-bordered text-center align-middle mb-0">
                ...
                <tbody>
                    ...
                    <tr style="font-size: 14px;">
                        ...
                        <td>
                            {{-- Tombol muncul hanya jika status = Pengajuan --}}
                            @if($company->status == 'Pengajuan')
                            ...
                            @elseif($company->status == 'Disetujui')
                                <span class="text-success small fw-bold">Sudah Disetujui</span>

                            @elseif($company->status == 'Ditolak')
                                <span class="text-danger small fw-bold">Sudah Ditolak</span>
                            @endif
                        </td>
