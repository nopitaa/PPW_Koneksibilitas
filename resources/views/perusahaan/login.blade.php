...
<body>
  <div class="card"> {{-- css gonna identified by class name, so make sure i remember each class name --}}
    ...
    <div class="card-body">
      ...
      <form id="form" action="{{ route('hit-login-perusahaan') }}" method="POST">
        @csrf
         ...
         <div class="input-group mb-3">
          ...
          <input type="text" class="form-control" name="email" placeholder="Email Perusahaan" value="{{ old('email') }}" aria-describedby="basic-addon1" required>
        </div>
      ...
      <p class = "penyedia-kerja">Masuk sebagai Pencari Kerja? <a href="{{ route('login') }}">Pencari kerja</a></p>
    </div>
  </div>
